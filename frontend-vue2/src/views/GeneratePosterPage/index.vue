<template>
  <div id="content" class="text-left">
    ...
    <p v-if="!hasCanteens && isAuthenticated" class="mt-0">
      ...
      <router-link :to="{ name: 'GestionnaireCantineRestaurantAjouter' }">créez votre cantine</router-link>
    ...
    <router-link :to="{ name: 'ComprendreMesObligations' }" class="text-decoration-underline primary--text text-body-2">
        ...
        <v-form ref="form" v-model="formIsValid" id="poster-form" @submit.prevent>
          ...
          <p>
            <DsfrTextField
              ...
              "
              id="total"
              v-model.number="form.diagnostic.valeurTotale"
          ...
          <p>
            ...
            <DsfrTextField
              id="bio"
              v-model.number="form.diagnostic.valeurBio"
              :rules="[validators.greaterThanZero, validators.decimalPlaces(2)]"
              placeholder="3000"
              suffix="euros HT"
              class="my-4"
            ...
            <DsfrTextField
              id="sustainable"
              v-model.number="form.diagnostic.valeurSiqo"
              :rules="[validators.greaterThanZero, validators.decimalPlaces(2)]"
              placeholder="2000"
              suffix="euros HT"
              class="my-4"
  ...
  computed: {
    ...
    usesCentralKitchenDiagnostics() {
      return (
        ...
        this.selectedCanteen?.centralKitchenDiagnostics?.some((x) => x.year === this.publicationYear)
      )
    },
    diagnosticSet() {
