...
class CanteenStatisticsView(APIView):
    ...
    def get(self, request):
        ...
        canteens = self._filter_canteens(regions, departments, epcis, pats, sectors, production_types)
        teledeclarations = self._filter_teledeclarations(
            year, regions, departments, epcis, pats, sectors, production_types
        )
    ...
    def _filter_canteens(self, regions, departments, epcis, pats, sectors, production_types):
    ...
    def _filter_teledeclarations(self, year, regions, departments, epcis, pats, sectors, production_types):
