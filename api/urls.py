...
urlpatterns = {
    ...
    path("canteens/<int:canteen_pk>/managers", UserCanteenManagersView.as_view(), name="canteen_managers_list"),
    path(
        "canteens/<int:canteen_pk>/managers/invitations",
        UserCanteenManagersInvitationsView.as_view(),
        name="canteen_managers_invitations_list",
    ),
    ...
    path("canteens/<int:canteen_pk>/teamJoinRequest/", TeamJoinRequestView.as_view(), name="canteen_team_request"),
    ...
    path("importPurchasesOld/", PurchasesImportOldView.as_view(), name="purchases_import_old"),
