...
class PurchaseSummarySerializer(serializers.Serializer):
    ...
    valeur_viandes_volailles_short_distribution = PurchaseField()
    valeur_produits_de_la_mer_short_distribution = PurchaseField()
    valeur_fruits_et_legumes_short_distribution = PurchaseField()
    valeur_charcuterie_short_distribution = PurchaseField()
    valeur_produits_laitiers_short_distribution = PurchaseField()
    valeur_boulangerie_short_distribution = PurchaseField()
    valeur_boissons_short_distribution = PurchaseField()
    valeur_autres_short_distribution = PurchaseField()
