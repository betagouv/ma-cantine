...
FIELDS = (
    ...
    "value_viandes_volailles_equivalents",
    "value_produits_de_la_mer_equivalents",
    "value_fruits_et_legumes_equivalents",
    "value_charcuterie_equivalents",
    "value_produits_laitiers_equivalents",
    "value_boulangerie_equivalents",
    "value_boissons_equivalents",
    "value_autres_equivalents",
