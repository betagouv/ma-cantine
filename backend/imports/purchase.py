...
PURCHASE_SIRET_SCHEMA_FILE_PATH = f"backend/imports/schemas/{PURCHASE_SIRET_SCHEMA_FILE_NAME}"
...
PURCHASE_ID_SCHEMA_FILE_PATH = f"backend/imports/schemas/{PURCHASE_ID_SCHEMA_FILE_NAME}"
