...
from backend.imports.base import BaseImportView


# simple
DIAGNOSTICS_SIMPLE_SIRET_SCHEMA_FILE_NAME = "bilans_simple_siret.json"
DIAGNOSTICS_SIMPLE_SIRET_SCHEMA_FILE_PATH = f"backend/imports/schemas/{DIAGNOSTICS_SIMPLE_SIRET_SCHEMA_FILE_NAME}"
...
DIAGNOSTICS_SIMPLE_ID_SCHEMA_FILE_PATH = f"backend/imports/schemas/{DIAGNOSTICS_SIMPLE_ID_SCHEMA_FILE_NAME}"
...
DIAGNOSTICS_COMPLETE_SCHEMA_FILE_PATH = f"backend/imports/schemas/{DIAGNOSTICS_COMPLETE_SCHEMA_FILE_NAME}"
