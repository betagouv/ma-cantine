  ...
  <div class="text-left">
    <div v-if="canteen" id="canteen-dashboard">
      ...
      <div v-if="showClaimCanteen">
        <v-alert v-if="undoSucceeded" colored-border color="primary" elevation="2" border="left" type="success">
          Vous n'êtes plus gestionnaire de cet établissement.
        </v-alert>
        <v-alert v-else-if="claimSucceeded" colored-border color="primary" elevation="2" border="left" type="success">
          <p>
          ...
          <p class="mb-0">
            ...
            <v-btn outlined color="primary" class="ml-2" @click="undoClaim">
    ...
    <v-progress-circular v-else indeterminate style="position: absolute; left: 50%; top: 50%"></v-progress-circular>
  </div>
</template>
