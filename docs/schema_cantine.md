...
|satellite_canteens_count (Nombre de restaurants satellites)|nombre entier|Nombre de restaurants satellites pour une cantine qui produit les repas sur place|0||
