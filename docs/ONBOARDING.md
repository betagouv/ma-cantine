...
### Installer les dépendances _des_ frontends
...
NOTICE_BANNER_SHOW= `True` - `False` pour afficher un bandeau d'information sous le menu
NOTICE_BANNER_TITLE= `Texte` titre du bandeau d'information
```
