...
renamed as (
    select
        ...
        -- par famille — totaux calculés (EGalim + non EGalim)
        nullif(coalesce(valeur_charcuterie_bio::float, 0)
            + coalesce(valeur_charcuterie_label_rouge::float, 0)
            + coalesce(valeur_charcuterie_aocaop_igp_stg::float, 0)
            + coalesce(valeur_charcuterie_hve::float, 0)
            + coalesce(valeur_charcuterie_peche_durable::float, 0)
            + coalesce(valeur_charcuterie_rup::float, 0)
            + coalesce(valeur_charcuterie_commerce_equitable::float, 0)
            + coalesce(valeur_charcuterie_fermier::float, 0)
            + coalesce(valeur_charcuterie_externalites::float, 0)
            + coalesce(valeur_charcuterie_performance::float, 0)
            + coalesce(valeur_charcuterie_non_egalim::float, 0), 0)                 as valeur_charcuterie,
        nullif(coalesce(valeur_fruits_et_legumes_bio::float, 0)
            + coalesce(valeur_fruits_et_legumes_label_rouge::float, 0)
            + coalesce(valeur_fruits_et_legumes_aocaop_igp_stg::float, 0)
            + coalesce(valeur_fruits_et_legumes_hve::float, 0)
            + coalesce(valeur_fruits_et_legumes_peche_durable::float, 0)
            + coalesce(valeur_fruits_et_legumes_rup::float, 0)
            + coalesce(valeur_fruits_et_legumes_commerce_equitable::float, 0)
            + coalesce(valeur_fruits_et_legumes_fermier::float, 0)
            + coalesce(valeur_fruits_et_legumes_externalites::float, 0)
            + coalesce(valeur_fruits_et_legumes_performance::float, 0)
            + coalesce(valeur_fruits_et_legumes_non_egalim::float, 0), 0)           as valeur_fruits_et_legumes,
        nullif(coalesce(valeur_produits_laitiers_bio::float, 0)
            + coalesce(valeur_produits_laitiers_label_rouge::float, 0)
            + coalesce(valeur_produits_laitiers_aocaop_igp_stg::float, 0)
            + coalesce(valeur_produits_laitiers_hve::float, 0)
            + coalesce(valeur_produits_laitiers_peche_durable::float, 0)
            + coalesce(valeur_produits_laitiers_rup::float, 0)
            + coalesce(valeur_produits_laitiers_commerce_equitable::float, 0)
            + coalesce(valeur_produits_laitiers_fermier::float, 0)
            + coalesce(valeur_produits_laitiers_externalites::float, 0)
            + coalesce(valeur_produits_laitiers_performance::float, 0)
            + coalesce(valeur_produits_laitiers_non_egalim::float, 0), 0)           as valeur_produits_laitiers,
        nullif(coalesce(valeur_boulangerie_bio::float, 0)
            + coalesce(valeur_boulangerie_label_rouge::float, 0)
            + coalesce(valeur_boulangerie_aocaop_igp_stg::float, 0)
            + coalesce(valeur_boulangerie_hve::float, 0)
            + coalesce(valeur_boulangerie_peche_durable::float, 0)
            + coalesce(valeur_boulangerie_rup::float, 0)
            + coalesce(valeur_boulangerie_commerce_equitable::float, 0)
            + coalesce(valeur_boulangerie_fermier::float, 0)
            + coalesce(valeur_boulangerie_externalites::float, 0)
            + coalesce(valeur_boulangerie_performance::float, 0)
            + coalesce(valeur_boulangerie_non_egalim::float, 0), 0)                 as valeur_boulangerie,
        nullif(coalesce(valeur_boissons_bio::float, 0)
            + coalesce(valeur_boissons_label_rouge::float, 0)
            + coalesce(valeur_boissons_aocaop_igp_stg::float, 0)
            + coalesce(valeur_boissons_hve::float, 0)
            + coalesce(valeur_boissons_peche_durable::float, 0)
            + coalesce(valeur_boissons_rup::float, 0)
            + coalesce(valeur_boissons_commerce_equitable::float, 0)
            + coalesce(valeur_boissons_fermier::float, 0)
            + coalesce(valeur_boissons_externalites::float, 0)
            + coalesce(valeur_boissons_performance::float, 0)
            + coalesce(valeur_boissons_non_egalim::float, 0), 0)                    as valeur_boissons,
        nullif(coalesce(valeur_autres_bio::float, 0)
            + coalesce(valeur_autres_label_rouge::float, 0)
            + coalesce(valeur_autres_aocaop_igp_stg::float, 0)
            + coalesce(valeur_autres_hve::float, 0)
            + coalesce(valeur_autres_peche_durable::float, 0)
            + coalesce(valeur_autres_rup::float, 0)
            + coalesce(valeur_autres_commerce_equitable::float, 0)
            + coalesce(valeur_autres_fermier::float, 0)
            + coalesce(valeur_autres_externalites::float, 0)
            + coalesce(valeur_autres_performance::float, 0)
            + coalesce(valeur_autres_non_egalim::float, 0), 0)                      as valeur_autres,
