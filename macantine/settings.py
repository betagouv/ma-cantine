...
TELEDECLARATION_START_DATE = os.getenv("TELEDECLARATION_START_DATE", "")
TELEDECLARATION_END_DATE = os.getenv("TELEDECLARATION_END_DATE", "")
CORRECTION_START_DATE = os.getenv("CORRECTION_START_DATE", "")
CORRECTION_END_DATE = os.getenv("CORRECTION_END_DATE", "")
