<template>
  <div class="text-left">
    ...
    <p>
      La plateforme numérique « ma cantine » est destinée à accompagner au mieux les acteurs de la restauration
    ...
    <ul class="my-4">
      <li>
        ...
        relatives à l’établissement concerné (SIRET, nombre de repas,..), qui ne sont pas considérées comme des données
