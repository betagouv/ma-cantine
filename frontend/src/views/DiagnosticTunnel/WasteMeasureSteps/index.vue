<template>
  <div v-if="stepUrlSlug === 'plan-action'">
    <fieldset>
      ...
      <v-radio-group class="my-0" v-model="payload.hasWasteDiagnostic" hide-details @change="updatePayload">
        <v-radio
    ...
    <v-row>
      <v-col cols="12" sm="6">
        <fieldset>
          ...
          <v-radio-group class="my-0" v-model="payload.hasWasteMeasures" hide-details @change="updatePayload">
  ...
  <div v-else-if="stepUrlSlug === 'expérimentation'">
    ...
    <p class="body-2">
      Pour évaluer ses effets sur le gaspillage alimentaire, la satisfaction de vos convives et le taux de fréquentation
      de votre établissement, nous vous proposons de participer à une expérimentation prévue par la loi climat et
      résilience.
    </p>
    <p class="body-2">
    ...
    <p class="body-2">
      Vous serez amenés à répondre à des questions sur votre structure et la solution de réservation que vous aurez mise
      en place, ainsi qu’à transmettre des données relatives aux évaluations du gaspillage alimentaire, du taux de
      fréquentation et de la satisfaction des usagers sur une période de six mois.
    </p>
