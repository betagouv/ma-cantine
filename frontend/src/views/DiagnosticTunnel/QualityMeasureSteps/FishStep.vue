...
export default {
  ...
  computed: {
    ...
    erroringFields() {
      const fields = []
      if (this.totalProduitsDeLaMerError) fields.push("valueTotalHt")
      if (this.totalFamiliesError) fields.push(...["valueTotalHt", "valueViandesVolailles"])
      return fields
    },
  },
  methods: {
    ...
    checkTotal() {
      ...
      if (totalFish > total) {
        ...
        this.errorHelperFields.push(...["valueTotalHt", "valueViandesVolailles"])
      }
