  ...
  computed: {
    ...
    steps() {
      ...
      const simplifiedSteps = [
        ...
        {
          title: "Valeurs totales des autres achats EGalim ou critères d’achats",
  ...
  methods: {
    ...
    initialisePayload() {
      const originalValues = {
        ...
        valeurExternalitesPerformance: this.diagnostic.valeurExternalitesPerformance,
        valeurViandesVolailles: this.diagnostic.valeurViandesVolailles,
        valeurViandesVolaillesEgalim: this.diagnostic.valeurViandesVolaillesEgalim,
        valeurViandesVolaillesFrance: this.diagnostic.valeurViandesVolaillesFrance,
        valeurProduitsDeLaMer: this.diagnostic.valeurProduitsDeLaMer,
        valeurProduitsDeLaMerEgalim: this.diagnostic.valeurProduitsDeLaMerEgalim,
        valeurProduitsDeLaMerFrance: this.diagnostic.valeurProduitsDeLaMerFrance,
        valeurCharcuterieFrance: this.diagnostic.valeurCharcuterieFrance,
        valeurFruitsEtLegumesFrance: this.diagnostic.valeurFruitsEtLegumesFrance,
        valeurProduitsLaitiersFrance: this.diagnostic.valeurProduitsLaitiersFrance,
        valeurBoulangerieFrance: this.diagnostic.valeurBoulangerieFrance,
        valeurBoissonsFrance: this.diagnostic.valeurBoissonsFrance,
        valeurAutresFrance: this.diagnostic.valeurAutresFrance,
      }
