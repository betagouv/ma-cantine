  ...
  methods: {
    ...
    initialisePayload() {
      const originalValues = {
        valueTotale: this.diagnostic.valueTotale,
        diagnosticType: this.diagnostic.diagnosticType || "",
        valueBio: this.diagnostic.valueBio,
        valueBioDontCommerceEquitableHt: this.diagnostic.valueBioDontCommerceEquitable,
        valueSiqo: this.diagnostic.valueSiqo,
        valueEgalimAutres: this.diagnostic.valueEgalimAutres,
        valueEgalimAutresDontCommerceEquitable: this.diagnostic.valueEgalimAutresDontCommerceEquitable,
        valueExternalitesPerformance: this.diagnostic.valueExternalitesPerformance,
        valueViandesVolailles: this.diagnostic.valueViandesVolailles,
        valueViandesVolaillesEgalim: this.diagnostic.valueViandesVolaillesEgalim,
        valueViandesVolaillesFrance: this.diagnostic.valueViandesVolaillesFrance,
        valueProduitsDeLaMer: this.diagnostic.valueProduitsDeLaMer,
        valueProduitsDeLaMerEgalim: this.diagnostic.valueProduitsDeLaMerEgalim,
