<template>
  ...
  <div v-else>
    ...
    <p>
      Si vous avez des difficultés de connexion, contactez nous par email :
...
export default {
  ...
  methods: {
    ...
    checkToken() {
      if (this.token) {
        const errorMessage =
          "Une erreur est survenue, essayez de connecter à nouveau ou contactez nous directement à contact@egalim.beta.gouv.fr"
