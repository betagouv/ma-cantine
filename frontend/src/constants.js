export default Object.freeze({
  ...
  CentralKitchenImportLevels: [
    {
      ...
      description:
        "Ce type de fichier vous permet de renseigner vos données d'approvisionnement simplifiées au niveau du livreur des repas et de lister vos cuisines satellites seulement avec leurs données d'établissement. Les données d'approvisionnement sont donc rentrées une fois au niveau du livreur.",
      label: "Livreur avec bilan simple",
      help:
        "Vous voulez renseigner vos cuisines satellites et vous connaissez les valeurs totaux, bio, et de qualité et durable",
      icon: "$bar-chart-box-fill",
    },
    {
      key: "CC_COMPLETE",
      ...
      description:
        "Ce type de fichier vous permet de renseigner vos données d'approvisionnement détaillées au niveau du livreur des repas et de lister vos cuisines satellites seulement avec leurs données d'établissement. Les données d'approvisionnement sont donc rentrées une fois au niveau du livreur.",
      label: "Livreur avec bilan complet",
      help:
        "Vous voulez renseigner vos cuisines satellites et vous connaissez les labels et les familles de produits de vos achats",
      icon: "$checkbox-circle-fill",
    },
  ],
  MiscLabelIcons: {
  ...
  CentralKitchenDiagnosticModes: [
    {
      key: "ALL",
      label: "Je rentre les données concernant toutes les mesures EGalim pour mes cuisines satellites",
      shortLabel: "Les données sur l’ensemble des mesures EGalim",
    },
    {
      key: "APPRO",
      label: "Je rentre seulement les données d'approvisionnement pour mes cuisines satellites",
