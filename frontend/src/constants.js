export default Object.freeze({
  ...
  TeledeclarationCharacteristics: {
    // NB: the order of these can affect the aesthetics of the display on PurchasePage, esp for long texts
    BIO: { text: "Bio", color: "green", colorHex: "#4CAF50" },
    LABEL_ROUGE: { text: "Label rouge", color: "red lighten-1", colorHex: "#EF5350" },
    AOCAOP_IGP_STG: {
    ...
    PECHE_DURABLE: { text: "Écolabel pêche durable", color: "blue", colorHex: "#2196F3" },
    RUP: { text: "RUP", longText: "Région ultrapériphérique (RUP)", color: "brown", colorHex: "#795548" },
    COMMERCE_EQUITABLE: { text: "Commerce équitable", color: "lime darken-2", colorHex: "#AFB42B" },
    HVE: {
    ...
    NON_EGALIM: { text: "Non-EGAlim", color: "blue-grey lighten-2", colorHex: "#90A4AE" },
