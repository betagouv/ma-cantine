<template>
  <div>
    <v-checkbox
      ...
      label="J’informe mes convives sur la part de produits EGalim, entrant dans la composition des repas servis, et sur les démarches d’acquisition de produits issus d'un PAT (projet alimentaire territorial)"
      :readonly="readonly"
      :disabled="readonly"
    />
