    ...
    approItems() {
      ...
      if (this.diagnostic.diagnosticType === "COMPLETE") {
        return [
          ...
          { param: "valeurViandesVolaillesShortDistribution", label: "Mes achats viandes et volailles circuit-court" },
          {
            param: "valeurProduitsDeLaMerShortDistribution",
            label: "Mes achats poissons, produits de la mer et de l'aquaculture circuit-court",
          },
          { param: "valeurFruitsEtLegumesShortDistribution", label: "Mes achats fruits et legumes circuit-court" },
          { param: "valeurCharcuterieShortDistribution", label: "Mes achats charcuterie circuit-court" },
          { param: "valeurProduitsLaitiersShortDistribution", label: "Mes achats produits laitiers circuit-court" },
          { param: "valeurBoulangerieShortDistribution", label: "Mes achats boulangerie circuit-court" },
          { param: "valeurBoissonsShortDistribution", label: "Mes achats boissons circuit-court" },
          { param: "valeurAutresShortDistribution", label: "Mes autres achats circuit-court" },
