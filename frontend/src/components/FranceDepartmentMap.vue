<template>
  <!-- Merci https://github.com/regisenguehard/carte-france-svg -->
  <div class="carte" @click="$emit('departmentClick', departmentCode($event))">
    <svg
      version="1.1"
...
export default {
  methods: {
    departmentCode(event) {
      return event.target.getAttribute("data-numerodepartement")
    },
  },
}
</script>
