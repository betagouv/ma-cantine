...
```{python}
print(utils.TUNNEL_DATA_ENG['2023'])
...
with plt.style.context("fivethirtyeight"):
    ...
    plt.fill_betweenx(y=[11,12], x1=[17,18], x2=[1,0], color="dodgerblue", alpha=0.5);
    plt.fill_betweenx(y=[9,11], x1=[17,17], x2=[1,1], color="dodgerblue");

    plt.fill_betweenx(y=[8,9], x1=[16,17], x2=[2,1], color="dodgerblue", alpha=0.5);
    plt.fill_betweenx(y=[6,8], x1=[16,16], x2=[2,2], color="dodgerblue");

    plt.fill_betweenx(y=[5,6], x1=[15,16], x2=[3,2], color="dodgerblue", alpha=0.5);
    plt.fill_betweenx(y=[3,5], x1=[15,15], x2=[3,3], color="dodgerblue");

    plt.fill_betweenx(y=[2,3], x1=[14,15], x2=[4,3], color="dodgerblue", alpha=0.5);
    plt.fill_betweenx(y=[0,2], x1=[14,14], x2=[4,4], color="dodgerblue");

    plt.yticks([1,4,7,10,13], df.index[::-1]);
    plt.xticks([],[]);
    ...
    plt.title("Chaîne de traitement des télédéclarations", loc="left", fontsize=25, fontweight="bold");
    plt.show()
```
...
"Nombre de TD ayant déclaré Je Ne Sais Pas pour la famille Viande/Volaille 🥩",
...
"Nombre de TD ayant déclaré Je Ne Sais Pas pour la famille Poissons/produits de la mer 🐟",
