...
## Comparaison des stratétiges de valeurs manquantes
...
indic_divers, indic_appro = utils.calcul_indicateur(tds, years=["2022_strat_2", "2022_strat_hist"])

indic_divers = indic_divers.rename(columns={'2022_strat_2': 'Données 2022 - Stratégie "Je Ne Sais Pas"', '2022_strat_hist': 'Données 2022 - Stratégie "Historique"'})
...
indic_appro = indic_appro.rename(columns={'2022_strat_2': 'Données 2022 - Stratégie "Je Ne Sais Pas"', '2022_strat_hist': 'Données 2022 - Stratégie "Historique"'})
...
indic_divers, indic_appro = utils.calcul_indicateur(tds, years=["2021_strat_2", "2022_strat_2"])
indic_divers = utils.ajout_col_comparaison(indic_divers)

indic_divers = indic_divers.rename(columns={'2022_strat_2': 'Données 2022', '2021_strat_2': 'Données 2021'})
...
indic_appro = indic_appro.rename(columns={'2022_strat_2': 'Données 2022', '2021_strat_2': 'Données 2021'})
utils.display_indicateurs(indic_appro)
```
