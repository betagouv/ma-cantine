  ...
  CentralKitchenImportLevels: [
    {
      ...
      help:
        "Vous ne connaissez pas les données par cuisine satellite, que par livreur de repas. Vous connaissez que les valeurs totales de vos achats bio et de qualité",
    },
    {
      key: "CC_COMPLETE",
      ...
      help:
        "Vous ne connaissez pas les données par cuisine satellite, que par livreur de repas. Vous connaissez les labels et les familles de produits de vos achats",
    },
  ],
  WasteMeasurement: {
    daysInPeriod: {
