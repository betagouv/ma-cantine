...
<template>
  ...
  <div class="fr-mb-5w">
    ...
    <p>
      Retrouvez et partagez vos résultats sur votre
      <strong>page publique</strong>
      pour valoriser vos initiatives auprès des convives et des acteurs de votre territoire. Vous pouvez
      <strong>imprimer votre affiche</strong>
      directement à partir des informations de votre page publique, pour une communication visible et accessible sur
      place.
    </p>
  </div>

  <AppSeparator class="fr-my-5w" />

  <div>
    <div class="ma-cantine--flex-between ma-cantine--flex-gap-1 fr-mb-4w">
      <h3 class="fr-h5 fr-mb-0">Votre page publique</h3>
      <DsfrButton label="Voir ma page en ligne" icon="ri-global-line" @click="goToOnlinePage(canteenInformations)" />
    </div>
    <p>
      <strong>Personnalisez votre espace public</strong>
      et donnez de la visibilité à vos actions auprès des convives, des collectivités et du territoire, dans un espace
      dédié aux initiatives durables et inspirantes.
    </p>

    <ol class="ma-cantine--ordered-list ma-cantine--unstyled-list">
      <CanteenFormLogo v-if="canteenInformations.id" :canteen-id="canteenInformations.id" class="fr-mb-3w" />
      <CanteenFormImages v-if="canteenInformations.id" :canteen-id="canteenInformations.id" class="fr-mb-3w" />
    </ol>
  </div>
  ...
  <div class="fr-mb-5w">
    <div class="ma-cantine--flex-between ma-cantine--flex-gap-1 fr-mb-4w">
      <h3 class="fr-h5 fr-mb-0">Générer et imprimer votre affiche</h3>
      <DsfrButton label="Imprimer mon affiche" icon="fr-icon-printer-line" @click="goToPrintPage" />
    </div>
    <p>
