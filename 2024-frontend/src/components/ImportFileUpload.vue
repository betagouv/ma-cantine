...
const props = defineProps(["apiUrl", "apiImportType", "apiSchema", "eventMatomo"])
...
const upload = (file) => {
  ...
  initErrors()
  importFile({ file: file, apiUrl: props.apiUrl, importType: props.apiImportType, schema: props.apiSchema })
    .then((json) => {
