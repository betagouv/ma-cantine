...
const props = defineProps(["viandesVolaillesProduitsDeLaMerEgalimPercent"])
...
const stats = reactive([props.viandesVolaillesProduitsDeLaMerEgalimPercent])
...
<template>
  ...
  <GraphBase :valuesToVerify="[props.viandesVolaillesProduitsDeLaMerEgalimPercent]" :description="description">
