...
<template>
  <section
    class="canteen-form-restaurant fr-background-alt--blue-france fr-p-3w fr-mt-4w fr-grid-row fr-grid-row--center"
  >
    <form class="fr-col-12 fr-col-lg-7 fr-background-default--grey fr-p-2w fr-p-md-7w" @submit.prevent="">
      ...
      <fieldset class="fr-mb-4w">
        ...
        <div class="fr-grid-row fr-grid-row--gutters">
          <div class="fr-col-12">
            <p class="fr-mb-0">Pour bien calculer son nombre de couverts retrouvez <a :href="documentation.calculerNombreCouverts" target="_blank">notre documentation</a></p>
          </div>
          <div class="fr-col-12 fr-col-md-6">
            <DsfrInputGroup
