const getFields = async (schemaFile) => {
  const url = `https://raw.githubusercontent.com/betagouv/ma-cantine/refs/heads/charline-l/import-excel--simplify-verifiations/data/schemas/imports/${schemaFile}`
