const getFields = async (schemaFile) => {
  const url = `https://raw.githubusercontent.com/betagouv/ma-cantine/refs/heads/charline-l/imports--canteen-remove-central-serving-option/data/schemas/imports/${schemaFile}`
