...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.CharField(choices=[('draft', '🔒 Non publié'), ('pending', '❓ En attente de vérification'), ('published', '✅ Publié')], default='draft', max_length=50, verbose_name='état de publication'),
        ),
