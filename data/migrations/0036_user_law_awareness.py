        ...
        migrations.AddField(
            ...
            field=data.fields.ChoiceArrayField(
                base_field=models.CharField(
                    choices=[
                        ("NONE", "Je n’ai pas une connaissance détaillée de l’article 24 de la loi EGAlim"),
                        ("AIMS_DEADLINES", "Je connais les objectifs et les échéances"),
                        ("ELIGIBLE_LABELS", "Je connais la liste des labels éligibles et mentions valorisantes"),
                        (
                            "MY_LABELS",
                        ...
                        ("TAKEN_STOCK", "J’ai réalisé un état des lieux précis de mes approvisionnements"),
                        (
                            "OPTION_DIAGNOSTIC",
