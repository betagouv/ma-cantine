# Generated by Django 5.1 on 2025-09-02 14:36
# Migration similar to 0173_repopulate_fields_agg_meal_price
...
def unpopulate_aggregated_fields(apps, schema_editor):
    ...
    for td in Teledeclaration.objects.all():
        ...
        td.value_meat_poultry_egalim_ht_agg = None
        td.value_meat_poultry_france_ht_agg = None
        td.value_fish_egalim_ht_agg = None
        td.save()
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("data", "0210_historicalteledeclaration_value_fish_egalim_ht_agg_and_more"),
    ]
