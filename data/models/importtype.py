...
class ImportType(models.TextChoices):
    ...
    CC_SIMPLE = "CC_SIMPLE", "Livreurs avec un diagnostic simple et leurs cuisines satellites"
    CC_COMPLETE = "CC_COMPLETE", "Livreurs avec un diagnostic complet et leurs cuisines satellites"
