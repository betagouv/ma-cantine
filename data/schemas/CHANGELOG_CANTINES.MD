...
* Colonne 'declaration_donnees_2025'

## 2025-11-24

### Modification

* La colonne `sectors` est renommée à `sector_list`, et renvoie maintenant une liste de secteurs sous forme de chaine de caractères séparés par une virgule
